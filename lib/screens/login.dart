...
class _LoginSignUpPageState extends State<LoginSignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('Gebetshaus Freiburg'),
        ),
        body: Stack(
          children: <Widget>[
            _showBody(context),
  ...
  void _showVerifyEmailSentDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Konto bestätigen"),
          content: new Text("Ein Link zur Kontoverifizierung wurde an die angegebene eMail gesendet."),
          actions: <Widget>[
            new FlatButton(
              child: new Text("Ok"),
              onPressed: () {
  ...
  Widget _showSecondaryButton() {
    return new FlatButton(
      child: _formMode == FormMode.LOGIN
          ? new Text('Erstelle ein Konto',
              style: new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w300))
          : new Text('Existiert ein Konto? Anmeldung',
              style:
